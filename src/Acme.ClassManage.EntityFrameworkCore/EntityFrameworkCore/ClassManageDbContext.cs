...
public class ClassManageDbContext :
    AbpDbContext<ClassManageDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(ClassManageConsts.DbTablePrefix + "YourEntities", ClassManageConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});


        builder.Entity<SinhVien>(builder =>
        {
            builder.ToTable(ClassManageConsts.DbTablePrefix + "SinhViens", ClassManageConsts.DbCommonSchema);
        ...
        builder.Entity<LopHoc>(builder =>
        {
            ...
            builder.Property(s => s.name).HasMaxLength(255).IsRequired(true);
            builder.Property(s => s.ghichu).HasMaxLength(1000).IsRequired(true);
            builder.ConfigureByConvention();
        });
